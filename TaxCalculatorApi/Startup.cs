...
namespace TaxCalculatorApi
{
    public class Startup
    {
        ...
        {
            services.AddScoped<ITaxProcessingService, TaxProcessingService>();
            services.AddScoped<ITaxCalculationService, ImaginariaTaxCalculationService>();
            services.AddScoped<IPayerStorageService, PayerStorageService>();
        }
    }
}
